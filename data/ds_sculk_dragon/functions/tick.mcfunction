...
execute if score ds_sculk_dragon ds_sculk_dragon_slower_tick matches 20.. run function ds_sculk_dragon:sculk_dragon_wing_auto_unlock/slower_tick
execute if score ds_sculk_dragon ds_sculk_dragon_slower_tick matches 20.. run function #ds_sculk_dragon:slower_tick
execute if score ds_sculk_dragon ds_sculk_dragon_slower_tick matches 20.. run scoreboard players set ds_sculk_dragon ds_sculk_dragon_slower_tick 0
